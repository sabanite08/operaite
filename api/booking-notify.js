...
function shell(innerHtml) {
  return [
    ...
    '<a href="' + SITE + '" style="text-decoration:none;color:inherit;display:inline-flex;align-items:center;gap:8px;">',
    '<span style="display:inline-block;width:28px;height:28px;background:#534AB7;border-radius:8px;line-height:28px;text-align:center;color:#fff;font-weight:700;font-size:13px;">O</span>',
    '<span style="font-size:17px;font-weight:700;">Opera<span style="color:#534AB7;">ite</span></span>',
    '</a>',
    '</td></tr>',
